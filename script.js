    ...
    */
    ...
    const translations = {
        ...
        'zh-hk': {
            ...
            'modal_step2_title': '选择节点', 'modal_step2_body': '选择您的参与节点。将应用稳定代币和平台代币比例。',
            'modal_step3_title': '完成', 'modal_step3_body': '将所选金额发送到下方的官方 BSC 地址。', 'modal_copy': '复制地址', 'modal_payment_note': '一旦确认，您的账户将在 24 小时内激活。', 'modal_finish': '我已支付',
            'modal_referrer_label': '推荐人钱包地址（必选）', 'err_invalid_referrer': '无效的推荐人地址。推荐人必须是已获得批准的节点持有者。',
            'nav_portal': '节点门户', 'portal_title': '节点门户', 'portal_desc': '输入您的钱包地址以查看您的节点状态和配额。', 'portal_view_btn': '查看我的节点', 'portal_status_active': '节点已激活', 'portal_status_pending': '审核中', 'portal_label_tier': '节点参与额', 'portal_label_ausd': 'AUSD 余额', 'portal_label_olym': 'OLYM 配额', 'portal_exit': '退出门户', 'portal_pending_msg': '审核正在进行中。批准后，您的配额将显示在此处。',
            'tier_3k_label': '+ 标准配额', 'tier_5k_label': '+ 增强配额', 'tier_10k_label': '+ 创世优先级',
            'portal_buy_again': '增购 / 升级节点'
        },
        'jp': {
