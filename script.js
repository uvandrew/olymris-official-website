    ...
    */
    ...
    const translations = {
        ...
        'zh-hk': {
            ...
            'modal_step2_title': '选择等级', 'modal_step2_body': '选择您的参与级别。将应用稳定代币和平台代币比例。',
            ...
            'nav_portal': '节点门户', 'portal_title': '节点门户', 'portal_desc': '输入您的钱包地址以查看您的节点状态和配额。', 'portal_view_btn': '查看我的节点', 'portal_status_active': '节点已激活', 'portal_status_pending': '审核中', 'portal_label_tier': '参与等级', 'portal_label_ausd': 'AUSD 余额', 'portal_label_olym': 'OLYM 配额', 'portal_exit': '退出门户', 'portal_pending_msg': '审核正在进行中。批准后，您的配额将显示在此处。',
